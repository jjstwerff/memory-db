 ...
 */
public class ChangeSpecial extends Special implements ChangeInterface {
	public ChangeSpecial(Store store) {
		super(store, store.allocate(Special.RECORD_SIZE));
		setName(null);
		setOpposite(null);
		setDescription(null);
		setTaste(false);
