...
public class Default_specialsArray implements MemoryRecord, ChangeInterface, Iterable<Default_specialsArray> {
	...
	@Override
	public Default_specialsArray copy(int rec) {
		assert store.validate(rec);
		return new Default_specialsArray(store, rec, -1);
	}
	...
	public Object java() {
		int field = 0;
		if (idx == -1)
			return field < 1 || field > size ? null : new Default_specialsArray(parent, field - 1);
		switch (field) {
		case 1:
			return getSpecial();
		case 2:
